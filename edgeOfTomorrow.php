...
<html>
	<head>
		<title>SILVERADO CINEMA - Edge Of Tomorrow</title>
		<meta charset="UTF-8" />
		...
		<meta name="keywords" content="Silverado,Cinema,3D,Edge Of Tomorrow" />
	...
	<body onload="resetZero()" class="bodyMovies">  		
		<!-- include hearder.php -->
		<?php include 'header.php';?>
		<div class="allMovieHeader ACtitle"></div>
		<div class="movieBlock">
			<div class="topBlock">
 		       <img class="imageBlock" id="ACposter">
			</div>				
			<div class="leftBlock">			
				<h2 class="ACtitle"></h2>
		    		...
		    		<h1>Buy Tickets</h1>
		   			<div class="content2">
		     			...
		     			<div id="booking">
					      ...
					      <input id="film" name="film" type="hidden" value="AC"/>
